...
namespace GamepadInput
{
    ...
    public static class GamePad
    {
        ...
        /// <returns></returns>
        public static Vector2 GetAxis(Axis axis, Index controlIndex, bool raw = true)
        {
        ...
        public static float GetTrigger(Trigger trigger, Index controlIndex, bool raw = true)
        {
            //
            string name = "";
